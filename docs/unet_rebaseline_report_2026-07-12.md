...
状态：已完成；保留为 2026 年 7 月工程对照。2026 年 8 月语义 QC 后，它不再
作为论文最终基线，正式 Task 1 需要在 769 个 QC-clean 样本上重跑。
...
下列验收线是 2026 年 7 月工程目标。正式论文比较必须统一改用 769 个
QC-clean 独立样本和对应固定 split；本报告的历史数字不得冒充 Task 1 正式结果。
