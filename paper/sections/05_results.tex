...
\IfFileExists{figures/segmentation_qualitative.pdf}{%
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/segmentation_qualitative.pdf}
  \caption{Frozen qualitative segmentation cases for seed 20260811. Rows were
  selected by prespecified evidence rather than visual preference: sample
  ...
  multi-channel overlap and bright green denotes stroke endpoints.}
...
\begin{figure}[t]
  ...
  {figures/coverage_correction_qualitative.png}
