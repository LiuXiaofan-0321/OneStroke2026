...
bins, giving a normalized 32-bin histogram \(h_p\). Centroid and radius
normalization reduce sensitivity to residual translation and isotropic
scale, although rasterization and bin boundaries can still affect the
histogram; this component's invariance is not separately measured here.
\emph{Grid occupancy} \(h_g\) counts normalized foreground over a
