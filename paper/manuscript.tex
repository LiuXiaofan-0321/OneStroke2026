...
\abstract{%
\textbf{Purpose:} Two handwritten instances of a Chinese character can be
equally legible yet differ in local stroke structure. We formulate
reference-conditioned structural assessment as an auditable
...
quality-controlled samples. We evaluate constrained similarity registration
and diagnostic evidence on cached masks from 200 references under controlled
perturbations.
Three structural scores are assessed on 150 natural pairs rated blindly by
...
clipping-safe cases while increasing structural penalties by 11.189 points.
The frozen production score, a coverage-aware score, and a
retrospectively developed aligned spatial-distribution similarity (ASDS)
reach Spearman correlations of 0.297, 0.429, and 0.556, respectively.
