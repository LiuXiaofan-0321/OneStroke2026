...
\noindent\textbf{Table \thetable:} Full per-perturbation score-drop statistics.
Nuisance rows use
absolute drop; structural rows use signed drop from the identity score.
Confidence intervals use reference-level bootstrap resampling. SD is the standard
deviation, P05--P95 the 5th--95th percentiles, Invalid the invalid fraction,
\(\rho_s\) the mean within-reference Spearman correlation across severity
levels, and Monotonic the fraction of adjacent severity steps with
non-increasing score.\par
...
Endpoint shift & 800 & 7.468 & 4.570 & 6.971 & [7.294, 7.641] & [0.000, 18.232] & 0.000 & -1.000 & 1.000 \\
\bottomrule
\end{tabular}%
}
\end{center}
