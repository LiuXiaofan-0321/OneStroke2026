...
drop; structural rows report signed drop from identity; 95\% CIs are
reference-level bootstrap intervals; Monotonic is the fraction of
non-increasing adjacent severity steps. Full distribution and
severity statistics are in Online Resource~1, Table~S1.}
...
Compound transform & 276 & 8.143 & [7.621, 8.717] & 0.540 & 0.466 \\
...
Endpoint shift & 800 & 7.468 & [7.294, 7.641] & 0.000 & 1.000 \\
\bottomrule
\end{tabular}
\end{table*}
